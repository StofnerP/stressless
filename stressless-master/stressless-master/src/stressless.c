...
static void hands_update_proc(Layer *layer, GContext *ctx) {
  ...
  switch (t->tm_hour) {
    case 1:
    case 13:
      old_color=GColorFromHEX(0x00FF60);
      curr_color=GColorFromHEX(0x099615);
      break;
    case 2:
    case 14:
      old_color=GColorFromHEX(0x099615);
      curr_color=GColorFromHEX(0x00FFFF);
      break;
    case 3:
    case 15:
      old_color=GColorFromHEX(0x00FFFF);
      curr_color=GColorFromHEX(0x00BFFF);
      break;
    case 4:
    case 16:
      old_color=GColorFromHEX(0x00BFFF);
      curr_color=GColorFromHEX(0x0060FF);
      break;
    case 5:
    case 17:
      old_color=GColorFromHEX(0x0060FF);
      curr_color=GColorFromHEX(0x5610AD);
      break;
    case 6:
    case 18:
      old_color=GColorFromHEX(0x5610AD);
      curr_color=GColorFromHEX(0xB60ECC);
      break;
    case 7:
    case 19:
      old_color=GColorFromHEX(0xB60ECC);
      curr_color=GColorFromHEX(0xFF00FF);
      break;
    case 8:
    case 20:
      old_color=GColorFromHEX(0xFF00FF);
      curr_color=GColorFromHEX(0xD10000);
      break;
    case 9:
    case 21:
      old_color=GColorFromHEX(0xD10000);
      curr_color=GColorFromHEX(0xFF7700);
      break;
    case 10:
    case 22:
      old_color=GColorFromHEX(0xFF7700);
      curr_color=GColorFromHEX(0xEDB10C);
      break;
    case 11:
    case 23:
      old_color=GColorFromHEX(0xEDB10C);
      curr_color=GColorFromHEX(0xFFFF00);
      break;
    case 12:
    case 0:
      old_color=GColorFromHEX(0xFFFF00);  
      curr_color=GColorFromHEX(0x00FF60);
      break;
  }
